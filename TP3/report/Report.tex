...
that are in it of them selves \textit{Domain Specific Languages}.
...
Another problem that needs to be taken into account is UTF-8 encoding.
%TODO: GET BETTER SHIT WRITTEN HERE
...
\begin{itemize}
    ...
    \item \texttt{-h | ----no--header}: So the output does not contain any
        \LaTeX{} headers.
\end{itemize}
